...
@router.get("/url_queue", status_code=status.HTTP_200_OK)
...
@router.get("/url_queue/{url_queue_id}", status_code=status.HTTP_200_OK)
...
@router.post("/url_queue", status_code=status.HTTP_201_CREATED)
