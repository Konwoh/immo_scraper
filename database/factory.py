...
class EstateFactory(ABC):
    def _base_params(self, params: Dict[str, Any], agency: Agency | None) -> Dict[str, Any]:
        return {
            ...
            "house_money": params.get("house_money"),
            ...
            "bathrooms": to_int(params.get("bathrooms")),
            "floor": params.get("floor"),
            "garage_parking_slots": to_int(params.get("garage_parking_slots")),
            "garden": params.get("garden"),
            "internet_speed_telekom": params.get("internet_speed_telekom"),
            "lift": params.get("lift"),
            "barrier_free": params.get("barrier_free"),
            "fitted_kitchen": params.get("fitted_kitchen"),
            "basement": params.get("basement"),
            "rented": params.get("rented"),
